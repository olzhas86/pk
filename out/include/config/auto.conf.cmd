...
ifneq "$(CC_VERSION_TEXT)" "Ubuntu clang version 21.0.0 (++20250329052842+e16541e1a6c0-1~exp1~20250329173033.1359)"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ld.lld"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" " --target=aarch64-linux-gnu --prefix=/workspaces/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9/bin/aarch64-linux-gnu- --gcc-toolchain=/workspaces/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9 -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
